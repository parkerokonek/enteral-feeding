...
\\\\
Qt: This framework includes many built-in features and covers a wide variety of platforms, including macOS, windows, and linux. 
The framework is also widely used in the open-source community and has support for a variety of languages, including C++, Java, and Python.
