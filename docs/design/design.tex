...
\section{Definitions}
\begin{itemize}
    \item \textit{Enteral Feeding: } A method of supplying nutrition to patients by providing a nutrient soup into the intestinal tract via a tube inserted into the mouth, stomach, or lower intestine.
\end{itemize}
%other weird words?
%etc.
